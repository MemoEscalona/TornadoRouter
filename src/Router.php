	...
	class Router{
	    ...
	    public function attach() {
	        ...
	        if (!is_subclass_of($className, '\TornadoRouter\BaseMiddleware')) {
	            throw new TornadoRouterException("Middleware class: '$className' does not exist or is not a sub-class of \TornadoRouter\BaseMiddleware" );
	        }
	    ...
	    public function route($uri = null) {
	        ...
	        if($result==null){
        		throw new TornadoRouterException('Invalid path');
	        }
	        return $result;
    	}
    	/**
